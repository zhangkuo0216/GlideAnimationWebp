 ...
 */
public class WebpDrawable extends Drawable
        implements WebpFrameLoader.FrameCallback, Animatable, Animatable2Compat {
     ...
     * {@link WebpDrawable#setLoopCount(int)}.
     *
    ...
    static final class WebpState extends ConstantState {
        @VisibleForTesting final WebpFrameLoader frameLoader;
